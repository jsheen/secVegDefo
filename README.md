...
## code
- ```1_inlaSmooth_InteriorEdge.R```: main model results (with B-spline on the age-stratified deforestation of secondary vegetation with four degrees of freedom and intercept)
