...
- 1_inlaSmooth_InteriorEdge: main model results
- 1_inlaSmooth_NoPropEdge: sensitivity analysis with no PropEdge
- 1_inlaSmooth_sens5: sensitivity analysis with 5 degrees of freedom
- 2_plot...: plotting scripts of above model results
- 3_compareInfo: comparison of WAIC and DIC information of above models
## code_output
