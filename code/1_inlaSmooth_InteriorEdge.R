...
for (input_state in amazon_states) {
  ...
  fwrite(m21_sub_summary, file=paste0('~/Desktop/secDef/mon_results/', state_abrev, '_age_smooth_sub_InteriorEdge.csv'), row.names=T)
  
  if (state_abrev == 'All') {
    save(m21_sub_results_sub, file=paste0('~/Desktop/secDef/mon_results/', state_abrev, '_age_smooth_sub_InteriorEdge.RData'))
  }
  ...
  save(spline_outputs, file=paste0('~/Desktop/secDef/mon_results/age_prof/smooth_', state_abrev, '_sub_InteriorEdge.RData'))
}
