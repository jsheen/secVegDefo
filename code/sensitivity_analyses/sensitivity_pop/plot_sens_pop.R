...
files <- list.files(data_dir, pattern = "smooth_.*_sub_sensPopInteriorEdge.RData", full.names = TRUE)
...
output_pdf <- "~/secVegDefo/code/sensitivity_analyses/sensitivity_pop/pop.pdf"
